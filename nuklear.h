...
#define NK_INCLUDE_FIXED_TYPES
	...
	#include "vmsys.h"
	typedef VMINT16 nk_short;
	typedef VMUINT16 nk_ushort;
	typedef VMINT32 nk_int;
	typedef VMUINT32 nk_uint;
	typedef VMUINT32 nk_hash;
	typedef VMUINT32 nk_size;
	typedef VMUINT32 nk_ptr;
	typedef VMUINT32 nk_flags;
	typedef VMUINT32 nk_rune;
	typedef VMUINT8 nk_byte;
#else
	#ifndef NK_BYTE
...
NK_GLOBAL const char nk_color_names[NK_COLOR_COUNT][50] = {
